...
namespace OrganicPortalBackend.Migrations
{
    ...
    [Migration("20250511155850_FixKeyInfo")]
    partial class FixKeyInfo
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OrganicPortalBackend.Models.Database.Solana.SolanaQrCodeModel", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("OrganicPortalBackend.Models.Database.Solana.SolanaQrCodeModel", b =>
                {
                    b.HasOne("OrganicPortalBackend.Models.Database.Solana.SolanaSeedModel", "SolanaSeed")
                        .WithOne("QrCode")
                        .HasForeignKey("OrganicPortalBackend.Models.Database.Solana.SolanaQrCodeModel", "SolanaSeedId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
