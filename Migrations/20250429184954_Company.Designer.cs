...
namespace OrganicPortalBackend.Migrations
{
    ...
    [Migration("20250429184954_Company")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OrganicPortalBackend.Models.Database.Seed.UseCERTModel", b =>
                {
                    ...
                    b.HasIndex("SeedModelId");

                    b.ToTable("UseCERTModel");
                });
            ...
            modelBuilder.Entity("OrganicPortalBackend.Models.Database.Seed.CERT.CERTFileModel", b =>
                {
                    b.HasOne("OrganicPortalBackend.Models.Database.Seed.UseCERTModel", "CRT")
                        .WithMany("FilesList")
                        .HasForeignKey("CRTId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("OrganicPortalBackend.Models.Database.Seed.UseCERTModel", b =>
                {
                    ...
                    b.HasOne("OrganicPortalBackend.Models.Database.Seed.SeedModel", null)
                        .WithMany("CERTsList")
                        .HasForeignKey("SeedModelId");
